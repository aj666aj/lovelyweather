...
public class Utility {
    ...
    public static Now handleNowWeatherResponse(String response){
        try{
            ...
            String updateTime = jsonArray.getJSONObject(0).getJSONObject("update").getString("loc");
            ...
            Now now = new Now(status,updateTime,wind_dir,pres,temperature,info);
            return now;
        }catch (Exception e){
            e.printStackTrace();
        }
    ...
    public static Weather handleWeatherResponse(String response, Now now, List<Suggestion> suggestions){
        try{
            ...
            return new Weather(status,basic,now,suggestions,forecasts);
        }catch (Exception e){
            e.printStackTrace();
        }
        return null;
